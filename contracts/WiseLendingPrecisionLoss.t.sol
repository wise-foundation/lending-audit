...
contract PrecisionLoss is IFlashLoanRecipient{
    ...
    IPositionNFTs public POSITION_NFT;
...
contract TestPrecisionLoss is BaseDeploymentTest {
        ...
        public
    {
        ...
        uint256 nftIdUsed = POSITION_NFTS_INSTANCE.mintPosition();
        ...
        bool chainLink = ORACLE_HUB_INSTANCE.chainLinkIsDead(
            0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599
        );

        bool chainLink2 = ORACLE_HUB_INSTANCE.chainLinkIsDead(
            0x5Ee5bf7ae06D1Be5997A1A72006FE6C607eC6DE8
        );

        console.log(chainLink, chainLink2, "chainlink");
