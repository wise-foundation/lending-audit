...
contract wstETHFarmTestExtra is wstETHFarmBase {
    ...
    function testSetBaseURL()
        public
    {
        string memory baseURL = powerFarmNFTs.baseURI();
        ...
        powerFarmNFTs.setBaseURI(
            newBase
        );

        string memory newBaseURL = powerFarmNFTs.baseURI();
    ...
    function testSetBaseExtension()
        public
    {
        string memory baseExtension = powerFarmNFTs.baseExtension();
        ...
        powerFarmNFTs.setBaseExtension(
            newExtension
        );

        string memory updatedExtension = powerFarmNFTs.baseExtension();
        ...
        public
    {
        ...
        string memory tokenURI = powerFarmNFTs.tokenURI(
            firstToken
        );
        ...
        string memory newTokenURI = powerFarmNFTs.tokenURI(
            firstToken
        );
        ...
        string memory wiseTokenURI = powerFarmNFTs.tokenURI(
            firstToken
        );

        console.log(wiseTokenURI, 'wiseTokenURI');
        ...
        public
    {
        ...
        uint256[] memory farmKeys = powerFarmNFTs.walletOfOwner(
            WISE_DEPLOYER
        );
