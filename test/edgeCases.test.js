...
contract("Edge Cases tests", async accounts  => {
    ...
    describe("Liquidation edge case tests", () => {
        ...
        it("Liquidation with 10 borrow and deposit tokens", async () => {
    ...
    describe("Miscellaneous tests", () => {
        ...
        it("maximumWithdrawToken works correct for more than one collat token", async () => {
            ...
            const amountUSDC = await contracts.security.maximumWithdrawToken(
                nftAlice,
                USDC.address,
                0,
                0
            ...
            const amountWETH = await contracts.security.maximumWithdrawToken(
                nftAlice,
                WETH.address,
                0,
                0
        ...
        it("maximumBorrowToken works correct", async () => {
            ...
            const borrowPerCap = await contracts.security.borrowPercentageCap();
            ...
            const amountUSDC = await contracts.security.maximumBorrowToken(
                1,
                USDC.address,
                0
            );
            ...
            const amountUSDC2 = await contracts.security.maximumBorrowToken(
                1,
                USDC.address,
                0
            );
        ...
        it("Extended maximumWithdraw function test", async () => {
        ...
        it("Extended maximumBorrow function test", async () => {
        ...
        it("overall borrow and lending apy test", async () => {
    ...
    describe("WithdrawBoth tests", () => {
        ...
        it("maximumWithdrawTokenSolely gives right amount (single withdraw)", async () => {
        ...
        it("maximumWithdrawTokenSolely gives right amount (normale and solely withdraw)", async () => {
            ...
            const maxWithdrawSoley = await contracts.security.maximumWithdrawTokenSolely(
                nftAlice,
                WETH.address,
                0,
                0
            ...
            const maxWithdrawPool = await contracts.security.maximumWithdrawToken(
                nftAlice,
                WETH.address,
                0,
                0
