...
contract("WiseLending", accounts => {
    ...
    describe("Basic deposit and withdraw tests", () =>{
        ...
        it("Deposit and withdraw", async () => {
            ...
            const sharesAlice = await contracts.lending.getPositionLendingShares(
                1,
                USDC.address
            );
        ...
        it("Withdraw scrapes extra tokens of same type correctly", async () => {

            const depositAmount = pow6(1000);
            const transferAmount = pow6(1000);
            const withdrawShares = pow6(100);
            ...
            const withdrawAmount = Bn(withdrawShares)
                .mul(Bn(pseudoPool))
                .div(Bn(totalShares))
