...
contract("Derivative Oracle tests", async accounts => {
    ...
    describe("Onchain WBTC oracle tests", () => {
        ...
        it("WBTC oracle gives reasonable USD value", async () => {
            ...
            const usdValue = await wbtcOracle.latestAnswer();

            debug("usdValue", usdValue);
        });
    });
    ...
    describe("Onchain WstETH oracle tests", () => {
        ...
        it("WstETH oracle gives reasonable value for price and heartbeat", async () => {
            ...
            const tokenUSD = await oracleHub.getTokensInUSD(
                WST_ETH_ADDRESS,
                amount
            );
    ...
    describe("Onchain TriCrypto oracle tests", () => {
    ...
    describe("CurveSecurity swap tests", () => {
        ...
        it("Curve Tri USDT creation and security swap works correctly", async () => {
            ...
            const collatUSD = await contracts.security.overallUSDCollateralsWeighted(
                nftOwner
            );
        ...
        it("Both pools (Mim and Tri) exists parallel and all security swaps are working", async () => {
            ...
            const collatUSD2 = await contracts.security.overallUSDCollateralsWeighted(
                nftOwner2
            );
