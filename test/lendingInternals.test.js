...
contract("WiseLending internals test", async (accounts) => {
    ...
    describe("allocateDepositShares() tests", () => {
        ...
        it("allocateDepositShares() works as intended (One user deposit)", async () => {
            ...
            const shareAmount = userLendingdata.shares;
        ...
        it("cashoutAmount() works as intended (One user deposit)", async () => {
            ...
            const calcAddAmount = Bi(depositAmount2)
                * Bi(pseudoPool)
                / Bi(totalShare);
        ...
        it("allocateDepositShares() works as intended (Two users deposit)", async () => {
            ...
            const shareAmount1 = user1Lendingdata.shares;
            const shareAmount2 = user2Lendingdata.shares;
    ...
    describe("allocateBorrowShares() tests", () => {
        ...
        it("allocateBorrowShares() works as intended (One user borrow)", async () => {
            ...
            const userBorroShares = await contracts.lending.getPositionBorrowShares(
                1,
                WETH.address
            );
        ...
        it("payoutAmount works as intended (One user borrow)", async () => {
            ...
            const usershares = await contracts.lending.getPositionBorrowShares(
                1,
                WETH.address
            );
        ...
        it("allocateBorrowShares() works as intended (Two user borrow)", async () => {
            ...
            const calcValue = Bi(borrowAmount2)
            ...
            const user1BorrowShares = await contracts.lending.getPositionBorrowShares(
                1,
                WETH.address
            );

            const user2BorrowShares = await contracts.lending.getPositionBorrowShares(
                2,
                WETH.address
            );
    ...
    describe("Updating user lendingTokenData tests (dynamical array updating) ", () => {
        ...
        it("Adding token address to array works as intended (One deposit)", async () => {
            ...
            let tokenAddress = await contracts.lending.positionLendingTokenData(
                1,
                0
            );
        ...
        it("Adding token address to array works as intended (Two deposit)", async () => {
            ...
            let tokenAddress1 = await contracts.lending.positionLendingTokenData(
                1,
                0
            );
            ...
            let tokenAddress2 = await contracts.lending.positionLendingTokenData(
                1,
                1
            );
        ...
        it("Remove token address from array works as intended (Two deposit)", async () => {
            ...
            const valUser = await contracts.security.overallUSDCollateralsWeighted.call(
                1
            );
            ...
            const bool = lendingData.collaterized;
            ...
            let newTokenAddress = await contracts.lending.positionLendingTokenData(
                1,
                0
            );
