...
setUpContracts = async (inputParam = {}) => {
    ...
    const eventHandler = await inputParam.EventHandler.new();
    ...
    // const eventHandlerAddress = eventHandler.address;
...
setUpAavePools = async (_AaveSecondLayer, _lendingAddress, _aaveAddress, _tokens) => {

    const WETH_ADDRESS = "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"; // FOR ETH MAINNET
