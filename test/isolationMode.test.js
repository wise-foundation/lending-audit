...
contract("Isolation Mode", async accounts  => {
    ...
    describe("Setting up Isolation Pool and Registration tests", () => {
        ...
        it("Registerd user can not interact with WISE lending anymore", async () => {
            ...
            await expectRevert(
                contracts.lending.solelyDeposit(
                    1,
                    USDC.address,
                    interactionAmount,
                    {
            ...
            await expectRevert(
                contracts.lending.paybackExactAmount(
                    1,
                    USDC.address,
                    interactionAmount,
                    {
            ...
            await expectRevert(
                contracts.lending.paybackExactShares(
                    1,
                    USDC.address,
                    interactionAmount,
                    {
    ...
    describe("Basic Isolation Contract Interaction Tests", () => {
        ...
        it("borrowExactDebtRatio borrows same amount as borrowExactUSD", async () => {
            ...
            const totalBorrowUser = await contracts.security.overallUSDBorrow.call(
                1
            );

            const totalCollateralUser = await contracts.security.overallUSDCollateralsWeighted.call(
                1
            );
        ...
        it("paybackAll works as intended", async () => {
            ...
            const borrowAmount = await contracts.security.overallUSDBorrow.call(
                1
            );
    ...
    describe("Basic Liquidation Tests", () => {
        ...
        it("User can't get liquidated by normal liquidation", async () => {
            ...
            const totalBorrow = await contracts.security.overallUSDBorrow.call(
                1
            );

            const totalCollatWeighted = await contracts.security.overallUSDCollateralsWeighted.call(
                1
            );
